...
urlpatterns = [
    ...
    path("verify/admission/", verification_views.public_verify_document, name="verify_admission_query"),
    path("verify/admission/<path:reference_no>/", verification_views.public_verify_document, name="verify_admission"),
    path("verify-admission/<path:reference_no>/", verification_views.public_verify_document, name="verify_admission_direct"),
    ...
    path("admissions/api/draft/", admissions_views.api_get_draft, name="admissions_api_get_draft"),
    path("admissions/api/draft/save/", admissions_views.api_save_draft, name="admissions_api_save_draft"),
    path("api/admissions/draft/", admissions_views.api_save_draft, name="api_admissions_draft"),
    path("admissions/api/submit/", admissions_views.api_submit_application, name="admissions_api_submit"),
    path("api/admissions/submit/", admissions_views.api_submit_application, name="api_admissions_submit"),
    path("admissions/api/intakes/available/", admissions_views.api_available_intakes, name="admissions_api_available_intakes"),
    path("admissions/api/intakes/available/", admissions_views.api_available_intakes, name="admissions_api_intakes_available"),
    path("api/admissions/intakes/available/", admissions_views.api_available_intakes, name="api_admissions_available_intakes"),
    path("api/admissions/intakes/available/", admissions_views.api_available_intakes, name="api_admissions_intakes_available"),
    path("admissions/api/locations/", admissions_views.api_locations, name="admissions_api_locations"),
    path("api/admissions/locations/", admissions_views.api_locations, name="api_admissions_locations"),
    ...
    path("admissions/<int:pk>/pay-fee/", admissions_views.pay_application_fee, name="admissions_fee_pay"),
