...
SYSTEM_MODULES_CATALOG = [
    ...
    },
    {
        ...
        "description": "Central registry for LMS, HR, finance, library, meeting providers, synchronization, and integration readiness.",
        "is_critical": False,
        "sort_order": 12,
        "target_roles": ["ADMIN"],
        "route_prefixes": [],
        "submodules": [
            {"code": "lms_integration", "name": "LMS Integration", "description": "Moodle, Canvas, Blackboard, or another approved learning platform.", "icon": "fa-solid fa-graduation-cap", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/lms/"]},
            {"code": "hr_smhr", "name": "HR / SMHR", "description": "Staff identity, employment lifecycle, and role synchronization.", "icon": "fa-solid fa-people-group", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/hr-smhr/"]},
            {"code": "finance_procurement", "name": "Finance & Procurement", "description": "Financial accounts, procurement workflows, reconciliation, and approvals.", "icon": "fa-solid fa-coins", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/finance-procurement/"]},
            {"code": "library_integration", "name": "Library Integration", "description": "Library accounts, borrowing, fines, and clearance synchronization.", "icon": "fa-solid fa-book-open-reader", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/library/"]},
            {"code": "meeting_integrations", "name": "Zoom / Teams / Blackboard", "description": "Meeting provider authentication, course mapping, and lifecycle controls.", "icon": "fa-solid fa-video", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/meetings/"]},
            {"code": "plugin_security", "name": "Plugin / Integration Security", "description": "Credential, webhook, encryption, retry, audit, and failure-recovery requirements.", "icon": "fa-solid fa-shield-halved", "is_critical": True, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/plugin-security/"]},
            {"code": "integration_health", "name": "Integration Health", "description": "Connection status, last sync, failures, and operational actions.", "icon": "fa-solid fa-heart-pulse", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/health/"]},
            {"code": "sync_recovery", "name": "Sync & Failure Recovery", "description": "Retries, idempotency, duplicate protection, reconciliation, and manual recovery.", "icon": "fa-solid fa-arrows-rotate", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/sync-recovery/"]},
            {"code": "integration_mapping", "name": "Integration Mapping", "description": "Authoritative data sources and approved synchronization directions.", "icon": "fa-solid fa-diagram-project", "is_critical": False, "route_names": ["integration_feature"], "path_patterns": ["/system-admin/integrations/mapping/"]},
        ],
    },
    {
        ...
        "description": "Central identity administration: one account per person, with credentials, account status, institutional email, groups and login security.",
        "is_critical": True,
        "sort_order": 3,
        "target_roles": ["ADMIN"],
        "route_prefixes": ["university:user_", "university:student_accounts", "university:staff_accounts",
                           "university:password_management", "university:account_status_board",
                           "university:username_management", "university:group_",
                           "university:email_accounts", "university:email_action",
                           "university:login_security", "university:login_history",
                           "university:bulk_", "university:api_generate", "university:api_check_username",
                           "university:send_test_email"],
        "submodules": [
            {
                "code": "user_directory",
                "name": "User Dashboard & Directory",
                "description": "Live identity metrics and the searchable, filterable directory of every account in the system.",
                "icon": "fa-solid fa-users",
                "is_critical": True,
                "route_names": ["user_dashboard", "user_list", "user_detail", "user_edit", "user_action",
                                "user_export", "user_activity"],
                "path_patterns": ["/system-admin/users/", "/system-admin/users/all/"],
                "features": [
                    {"code": "user_view", "name": "View User Accounts", "action_code": "VIEW", "description": "Read access to the user directory and individual profiles."},
                    {"code": "user_edit_details", "name": "Edit Account Details", "action_code": "EDIT", "description": "Change names, usernames, contact details and user type."},
                    {"code": "user_export_directory", "name": "Export User Directory", "action_code": "EXPORT", "description": "CSV, Excel and PDF export. Never includes credentials."},
                ],
            },
            {
                "code": "user_provisioning",
                "name": "Account Creation & Provisioning",
                "description": "Create accounts individually or from the admissions and staffing pipelines, with configurable username generation.",
                "icon": "fa-solid fa-user-plus",
                "is_critical": True,
                "route_names": ["user_create", "student_accounts", "staff_accounts", "username_management",
                                "api_generate_username", "api_check_username"],
                "path_patterns": ["/system-admin/users/create/", "/system-admin/users/students/",
                                  "/system-admin/users/staff/", "/system-admin/users/usernames/"],
                "features": [
                    {"code": "user_create_account", "name": "Create User Account", "action_code": "CREATE", "description": "Provision a new central identity."},
                    {"code": "user_generate_username", "name": "Generate Usernames", "action_code": "GENERATE", "description": "Build usernames from the configured institutional format."},
                ],
            },
            {
                "code": "credential_management",
                "name": "Password & Credential Management",
                "description": "Administrator reset consoles, secure reset links, temporary credentials and the institutional password policy.",
                "icon": "fa-solid fa-key",
                "is_critical": True,
                "route_names": ["password_management", "api_generate_password"],
                "path_patterns": ["/system-admin/users/passwords/"],
                "features": [
                    {"code": "user_send_reset_link", "name": "Send Password Reset Link", "action_code": "RESET", "description": "Email a single-use expiring reset link. The preferred reset path."},
                    {"code": "user_temp_password", "name": "Issue Temporary Password", "action_code": "GENERATE", "description": "Cryptographically generated fallback for controlled hand-over."},
                    {"code": "user_force_change", "name": "Force Password Change", "action_code": "UPDATE", "description": "Require a new password at the next sign-in."},
                ],
            },
            {
                "code": "account_lifecycle",
                "name": "Account Status & Lifecycle",
                "description": "Activate, deactivate, suspend, disable, expire and archive accounts, with immediate backend effect.",
                "icon": "fa-solid fa-toggle-on",
                "is_critical": True,
                "route_names": ["account_status_board"],
                "path_patterns": ["/system-admin/users/status/"],
                "features": [
                    {"code": "user_change_status", "name": "Change Account Status", "action_code": "UPDATE", "description": "Move an account between lifecycle states."},
                    {"code": "user_archive", "name": "Archive Account", "action_code": "DELETE", "description": "Retire an account while preserving all historical records."},
                ],
            },
            {
                "code": "user_groups",
                "name": "User Groups & Role Assignment",
                "description": "Population-level access management. Groups grant real role assignments through the single permission engine.",
                "icon": "fa-solid fa-users-rectangle",
                "is_critical": False,
                "route_names": ["group_list", "group_create", "group_edit", "group_delete",
                                "user_roles_permissions"],
                "path_patterns": ["/system-admin/users/groups/", "/system-admin/users/roles/"],
            },
            {
                "code": "institutional_email",
                "name": "Institutional Email Accounts",
                "description": "Issue and track institutional addresses, with a provider abstraction and honest provisioning status.",
                "icon": "fa-solid fa-envelope",
                "is_critical": False,
                "route_names": ["email_accounts", "email_action", "send_test_email"],
                "path_patterns": ["/system-admin/users/emails/"],
                "features": [
                    {"code": "email_generate", "name": "Generate Institutional Address", "action_code": "GENERATE", "description": "Build an address from the configured domain and format."},
                    {"code": "email_provision", "name": "Provision Mailbox", "action_code": "CREATE", "description": "Request mailbox creation from the configured provider."},
                ],
            },
            {
                "code": "login_security",
                "name": "Login Security & History",
                "description": "Lockouts, session control, sign-in history and the security event log.",
                "icon": "fa-solid fa-shield-halved",
                "is_critical": True,
                "route_names": ["login_security", "login_history"],
                "path_patterns": ["/system-admin/users/security/", "/system-admin/users/login-history/"],
                "features": [
                    {"code": "user_unlock", "name": "Unlock Accounts", "action_code": "UPDATE", "description": "Clear a lockout after failed sign-in attempts."},
                    {"code": "user_revoke_sessions", "name": "Revoke Active Sessions", "action_code": "DELETE", "description": "Sign a user out of every device immediately."},
                ],
            },
            {
                "code": "bulk_user_operations",
                "name": "Bulk User Operations",
                "description": "CSV and Excel import with a validate, preview and confirm workflow, plus bulk credential and email actions.",
                "icon": "fa-solid fa-layer-group",
                "is_critical": False,
                "route_names": ["bulk_operations", "bulk_import_template", "bulk_import_preview",
                                "bulk_import_commit", "bulk_import_report", "bulk_user_action"],
                "path_patterns": ["/system-admin/users/bulk/"],
                "features": [
                    {"code": "bulk_import_users", "name": "Bulk Import Users", "action_code": "IMPORT", "description": "Create many accounts from a validated spreadsheet."},
                    {"code": "bulk_credential_ops", "name": "Bulk Credential Operations", "action_code": "UPDATE", "description": "Reset links, forced changes and unlocks across many accounts."},
                ],
            },
            {
                "code": "user_settings",
                "name": "User Management Settings",
                "description": "Username rules, password policy, email configuration, notifications and login security thresholds.",
                "icon": "fa-solid fa-sliders",
                "is_critical": True,
                "route_names": ["user_settings"],
                "path_patterns": ["/system-admin/users/settings/"],
            },
        ],
    },
    {
    ...
    },
    {
        ...
        "description": "Public student applications, document uploads, application fee payment, review, registration, and enrollment.",
        "is_critical": False,
        "sort_order": 4,
        "target_roles": ["ALL"],
        ...
        "submodules": [
            {
                "code": "applications",
                "name": "Application Desk & Student Registration",
                "description": "Prospective student applications, review, fee payment, registration, and enrollment into active students.",
                "icon": "fa-solid fa-users-rectangle",
                "is_critical": False,
