# -*- coding: utf-8 -*-
"""Data migration to ensure important sections are bold in the admission letter template.
This migration updates the active AdmissionDocumentTemplate(s) to wrap key headings and
variables in <b> tags, matching the design intent of migration 0037.
"""

from django.db import migrations


def make_sections_bold(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [("university", "0045_alter_auditlog_action_and_more")]
    operations = [migrations.RunPython(make_sections_bold, migrations.RunPython.noop)]
