...
DEFAULT_SETTINGS = [
    ...
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "primary_domain",
        "label": "Primary University Root Domain",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "ums.ac.ke",
        "description": "Base internet root domain from which staff (@root) and student (@prefix.root) domains derive.",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "student_email_subdomain_prefix",
        "label": "Student Email Subdomain Prefix",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "students",
        "description": "Subdomain prefix for student emails (e.g., 'students' yields @students.domain.ac.ke).",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "email_staff_domain",
        "label": "Staff Institutional Email Domain",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "ums.ac.ke",
        "description": "Active email domain assigned to faculty and staff accounts.",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "email_student_domain",
        "label": "Student Institutional Email Domain",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "students.ums.ac.ke",
        "description": "Active email domain assigned to enrolled student accounts.",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "institution_website_url",
        "label": "Primary Institutional Website URL",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "https://ums.ac.ke",
        "description": "Public university portal and web address.",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "institution_portal_url",
        "label": "Student & Staff Portal URL",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "https://portal.ums.ac.ke",
        "description": "Active web URL for the UMS portal.",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "institution_admissions_email",
        "label": "Admissions Office Contact Email",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "admissions@ums.ac.ke",
        "description": "Official contact email for inquiries and application notifications.",
        "is_public": True,
    },
    {
        "category": SystemSetting.Category.UNIVERSITY,
        "key": "institution_finance_email",
        "label": "Student Finance Office Email",
        "value_type": SystemSetting.ValueType.STRING,
        "value": "finance@ums.ac.ke",
        "description": "Official contact email for fee inquiries, billing, and receipts.",
        "is_public": True,
    },
