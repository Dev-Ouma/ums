...
def seed_default_fee_accounts() -> List[FeeAccount]:
    ...
    defaults = [
        ...
        },
        {
            ...
            "account_name": "University Pochi la Biashara Account",
            "currency": "KES",
            "status": FeeAccount.Status.ACTIVE,
            "is_default": True,
            "environment": FeeAccount.Environment.PRODUCTION,
            "description": "Pochi la Biashara account for flexible payments from any M-Pesa user.",
            "configuration": {"callback_url": "/api/payments/callback/mpesa/"},
        },
        {
            "name": "eCitizen Payment Gateway",
            "account_type": FeeAccount.AccountType.ECITIZEN,
            "provider": FeeAccount.Provider.ECITIZEN,
            "account_identifier": "222222",
            "account_name": "University eCitizen Service",
            "currency": "KES",
            "status": FeeAccount.Status.ACTIVE,
            "is_default": True,
            "environment": FeeAccount.Environment.PRODUCTION,
            "description": "eCitizen payment gateway for government-regulated fees.",
            "configuration": {"callback_url": "/api/payments/callback/ecitizen/"},
        },
        {
