...
class SignUpForm(forms.ModelForm):
    """Public self-registration -> always creates a STUDENT account using Central Identity Services."""
    ...
    def clean(self):
        ...
        if p1:
            ...
            for err in validate_password(p1):
...
class IdentitySetPasswordForm(forms.Form):
    """Choose a new password, validated against central identity policy."""
